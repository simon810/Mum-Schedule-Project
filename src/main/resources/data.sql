...
--
-- -- *******************************registered-record**************
-- INSERT INTO register_record (id,block,course_code,title,faculty,start_date) VALUES (1,'JANUARY','CS544','EA','Salek','2020-01-01');
-- INSERT INTO register_record (id,block,course_code,title,faculty,start_date) VALUES (2,'FEBRUARY','CS574','MWA','Asad','2020-02-01');
-- INSERT INTO register_record (id,block,course_code,title,faculty,start_date) VALUES (3,'MARCH','CS411','Algorithm','Kuraza','2020-03-01');
-- INSERT INTO register_record (id,block,course_code,title,faculty,start_date) VALUES (4,'APRIL','CS522','WAA','Tina','2020-04-01');
-- INSERT INTO register_record (id,block,course_code,title,faculty,start_date) VALUES (5,'MAY','CS472','WAP','Michael','2020-05-01');
-- INSERT INTO register_record (id,block,course_code,title,faculty,start_date) VALUES (6,'JUNE','CS486','Software Engineering','Kalu','2020-06-01');
--
-- -- *******************************student-records**************
--
-- INSERT INTO student_records (student_id,record_id) VALUES (1,1);
-- INSERT INTO student_records (student_id,record_id) VALUES (1,2);
-- INSERT INTO student_records (student_id,record_id) VALUES (1,3);
-- INSERT INTO student_records (student_id,record_id) VALUES (1,4);
-- INSERT INTO student_records (student_id,record_id) VALUES (1,5);
-- INSERT INTO student_records (student_id,record_id) VALUES (1,6);
--
--
--
